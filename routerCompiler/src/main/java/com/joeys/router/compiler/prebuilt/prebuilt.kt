package com.joeys.router.compiler.prebuilt
...
val BUNDLE_UTILS=ClassType("com.joeys.router.runtime.BundleUtils")
val ACTIVITY_BUILDER=ClassType("com.joeys.router.runtime.ActivityBuilder")
